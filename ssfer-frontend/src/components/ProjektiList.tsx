...
export default function ProjektiList({sx}: {sx?: SxProps<Theme>}) {
    ...
    return (
        <Stack direction={"column"} justifyContent={"center"} alignItems={"center"} spacing={12} sx={sx}>
            <Grid container justifyContent={"center"} alignItems={"start"}>
                <Grid item xs={12} md={6} lg={5} xl={4}>
                    <Box sx={{position: "relative", height: {xs: "250px", md: "400px"}, width: "100%"}}>
                        <Image src={"/projekti/brucosijada.png"} alt={"Brucosijada"} fill={true} style={{objectFit: "cover"}} />
                    </Box>
                </Grid>
                <Grid item xs={12} md={6} lg={7} xl={8} height={{sx: "100%", md: "400px"}}>
                    <Stack direction={"column"}
                        ...
                        <Box display={"flex"} alignItems={"end"} height={{sx: "2rem", md: "100%"}}>
